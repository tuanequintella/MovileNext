...
public class LinearHorizontalRecyclerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.horizontal_recycler_activity);
    ...
    private void configureRecyclerView() {
        RecyclerView view = (RecyclerView) findViewById(R.id.horizontal_recycler);
        view.setLayoutManager(new LinearLayoutManager(this, LinearLayoutManager.HORIZONTAL, false));

        mAdapter = new RecyclerAdapter(this, R.layout.content_linear_horizontal_item);
